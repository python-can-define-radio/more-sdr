...
## This script was used for setting up SDRangel with proot.
## We no longer actively use it in class; planning to keep it here indefinitely (maybe till 2027?) in case it is useful.
